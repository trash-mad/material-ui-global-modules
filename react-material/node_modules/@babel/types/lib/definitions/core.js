...
(0, _utils.default)("BinaryExpression", {
  ...
  fields: {
    operator: {
      validate: (0, _utils.assertOneOf).apply(undefined, _toConsumableArray(_constants.BINARY_OPERATORS))
    },
    left: {
      validate: (0, _utils.assertNodeType)("Expression")
    },
...
(0, _utils.default)("LogicalExpression", {
  ...
  fields: {
    operator: {
      validate: (0, _utils.assertOneOf).apply(undefined, _toConsumableArray(_constants.LOGICAL_OPERATORS))
    },
    left: {
      validate: (0, _utils.assertNodeType)("Expression")
    },
...
(0, _utils.default)("UnaryExpression", {
  ...
  fields: {
    ...
    operator: {
      validate: (0, _utils.assertOneOf).apply(undefined, _toConsumableArray(_constants.UNARY_OPERATORS))
    }
  },
  visitor: ["argument"],
...
(0, _utils.default)("UpdateExpression", {
  ...
  fields: {
    ...
    operator: {
      validate: (0, _utils.assertOneOf).apply(undefined, _toConsumableArray(_constants.UPDATE_OPERATORS))
    }
  },
  visitor: ["argument"],
  aliases: ["Expression"]
